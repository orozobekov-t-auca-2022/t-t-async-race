...
export function showCarView(name: string, color: string): string {
  return `
    <div>
      ...
      <div>
        <div class="${styles['car-road']}">
        <div class="${styles['car-preview']}">
          <svg fill="${color}" class="${styles['car-image']}" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
	          width="800px" height="800px" viewBox="0 0 324.018 324.017"
	          xml:space="preserve">
            <g>
	            <g>
        ...
        <div class="${styles['flag-preview']}">
          <svg class="${styles['flag-image']}" fill="${color}" height="800px" width="800px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
        ...
        <div class="${styles['dotted-road']}"></div>
      </div>
    </div>
  `;
}
